...
funny = ['aardvark', 'abacus', 'abundance', 'ache', 'acupuncture',
         ...
         'hooligan', 'hooplah', 'hydrant', 'icicles', 'implode', 'implosion',
         'indeed', 'issue', 'itchy', 'jello', 'jewel', 'jump', 'kabob',
         ...
         'mozzarella', 'muck', 'moo', 'malarkey', 'mumble', 'mushy', 'mustache',
         'noodle', 'nostril', 'nuggets', 'oatmeal', 'oboe', 'o\'clock',
         'octopus', 'odor', 'ointment', 'olive', 'optic', 'overhead', 'ox',
